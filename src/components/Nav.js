...
const Nav = () => {
  ...
  return (
    <>
      <DesktopNav />
      <div className="container mx-auto md:w-[95%] bg-semiDarkBlue md:rounded-xl lg:hidden">
        <nav className="navbar">
          <div className="navbar-start">
            <Link href="/">
              <a className="btn btn-ghost normal-case text-xl px-1 hover:bg-transparent">
          ...
          <div className="navbar-center lg:flex">
            <ul className="menu menu-horizontal gap-7">
              <li>
                <Link href="/">
                  <a className="btn px-0 border-none bg-transparent block hover:bg-transparent focus:bg-transparent">
                    <svg
                      width="20"
                      height="20"
